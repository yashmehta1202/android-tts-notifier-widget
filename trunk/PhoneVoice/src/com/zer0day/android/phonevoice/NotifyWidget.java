...
public class NotifyWidget extends AppWidgetProvider {
	private static final String UPDATE = 
		NotifyWidget.class.getPackage().toString() + ".UPDATE";
	
	private static final int NOTIF_ID = 500;
	//stops widget from turning on when added to screen
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (action != null && action.equals(UPDATE)) {
			//update triggered via notification
			update = true;
